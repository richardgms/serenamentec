...
async function main() {
  ...
  const amIAutisticJourney = [
    {
      journeyType: 'AM_I_AUTISTIC' as const,
      step: 1,
  ...
  const understandingADHDJourney = [
    {
      journeyType: 'UNDERSTANDING_ADHD' as const,
      step: 1,
  ...
  const sensoryProcessingJourney = [
    {
      journeyType: 'SENSORY_PROCESSING' as const,
      step: 1,
  ...
  const topics = [
    {
      topicType: 'SENSORY_SENSITIVITY' as const,
      title: 'Sensibilidade Sensorial',
    ...
    {
      topicType: 'SOCIAL_COMMUNICATION' as const,
      title: 'Comunicação Social',
    ...
    {
      topicType: 'ROUTINES_RITUALS' as const,
    ...
    {
      topicType: 'SENSORY_OVERLOAD' as const,
      title: 'Sobrecarga Sensorial',
    ...
    {
      topicType: 'EXECUTIVE_FUNCTION' as const,
      title: 'Função Executiva',
